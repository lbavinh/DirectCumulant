...
void PlotV2DifferentialChargedHadrons_testNewWeight_AMPT08(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  TPaveLabel* label = new TPaveLabel(0.1,0.95,0.9,0.99,Form("AMPT, #it{#sigma}_{p}=0.8 mb, Au+Au at #sqrt{s_{NN}} = %s GeV, Charged Hadrons",energy.Data()));
  ...
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_v2{LYZ,Prod}_at_%s_testNewWeight_AMPT08.png",energy.Data()));
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_v2{LYZ,Prod}_at_%s_testNewWeight_AMPT08.pdf",energy.Data()));
