...
TCanvas *DrawTGraph(std::vector<TGraphErrors*> vgr, TString str,TString strCent="", 
                    ...
                    Double_t leg_x_high=0.42, Double_t leg_y_high=0.89)
{
  ...
  for (int igr=0; igr<vgrRatio.size();igr++)
  {
    ...
    vgrRatio.at(igr)->GetYaxis()->SetTitle(Form("[2]/[1]"));
