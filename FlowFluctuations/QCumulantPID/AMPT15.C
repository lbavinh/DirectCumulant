...
void AMPT15(TString inputFileName, TString outputFileName)
{
  TStopwatch timer;
  timer.Start();
...
// root -l -b -q AMPT.C+'("/weekly/lbavinh/lbavinh/AMPT/split/AMPT15_11.5/runlist_AMPT15_11.5_00.list","test.root")'