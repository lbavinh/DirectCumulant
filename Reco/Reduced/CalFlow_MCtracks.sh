...
#$ -o /weekly/$USER/lbavinh/Reco/OUT/log/
#$ -e /weekly/$USER/lbavinh/Reco/OUT/log/
#
...
#Main directory
export MAIN_DIR=/weekly/$USER/lbavinh/Reco
...
cp $MAIN_DIR/calculateFlow_MCtracks.C $TMP
...
root -l -b -q $TMP/calculateFlow_MCtracks.C+'("'${IN_FILE}'","'${OUT_FILE}'")' &>> $LOG
