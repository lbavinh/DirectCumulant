...
Bool_t ETASUBEVENTPLANE_1 = 1;
Bool_t ETASUBEVENTPLANE_2 = 0;
Bool_t LYZ_SUM_1 = 0;
Bool_t LYZ_SUM_2 = 0;
Bool_t LYZ_SUM_PRODUCT_1 = 1;
Bool_t LYZ_SUM_PRODUCT_2 = 0;
Bool_t SCALARPRODUCT_1 = 1;
Bool_t SCALARPRODUCT_2 = 0;
Bool_t QCUMULANT = 1;
Bool_t HIGHORDERQCUMULANT = 1;
Bool_t LYZEP = 0;
