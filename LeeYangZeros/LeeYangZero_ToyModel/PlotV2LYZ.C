...
void PlotV2LYZ(TString inputFileName = "LYZ_nonflow_M_1000_run1.root", TString inputFileName_sencondRun = "LYZ_nonflow_M_1000_run2.root")
{
  TString titleGraph = "Toy Model, 1M events, Nonflow, <M>=1000";
