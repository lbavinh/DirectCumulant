...
enum  ParticleSpecies {kHadronPos, kPionPos, kKaonPos, kProton, kHadronNeg, kPionNeg, kKaonNeg, kAntiProton};
...
const Int_t maxHarmonic = 5; // need to be very becareful with this
