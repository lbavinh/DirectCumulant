void RatioV24V22vsPt_1040(){
  ...
  for (int imod=0;imod<nmodel;imod++){
    ...
    if (imod==1 && ien==0) {
      ...
      // leg_pt->AddEntry(grRatioV2[ien][imod][2],legendEntries[1].Data(),"l");
    ...
    for (int icent=0;icent<ncent;icent++){
      if (icent!=1) continue;
      grRatioV2[ien][imod][icent]->Draw("L");
    }
  
  }
  }
  can->SaveAs("Figure_Ratiov24v22_vs_pt_10-40.pdf");
  gROOT->SetStyle("Pub");
  can->SaveAs("Figure_Ratiov24v22_vs_pt_10-40.png");
