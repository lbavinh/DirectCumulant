...
#$ -wd /weekly/$USER/lbavinh/GenericFramework
...
export energy=7.7
export model=UrQMD
export MAIN_DIR=/weekly/$USER/lbavinh/GenericFramework
export FILELIST=/weekly/lbavinh/lbavinh/ScalarProduct/split/runlistSGE_${model}_${energy}.list
