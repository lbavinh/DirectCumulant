...
void CalStatErrCent1040(TString model, TString energy,double v2eDif1040[nmethod][npid][npt]){
  ...
  TFile *inFile = new TFile(Form("../ROOTFile/%s_%s_samecutwithSTARBES.root",model.Data(),energy.Data()),"read");
...
void v2plot(TString model = "UrQMD", TString energy = "7.7GeV"){
  ...
  TString inFileName= (TString) Form("../ROOTFile/%s_%s_samecutwithSTARBES.root",model.Data(),energy.Data());
  TFile *outFile = new TFile(Form("./v2_%s_%s_samecutwithSTARBES.root",model.Data(),energy.Data()),"recreate");
