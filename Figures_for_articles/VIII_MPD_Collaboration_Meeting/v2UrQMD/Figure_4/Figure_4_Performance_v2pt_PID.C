...
//=========  (Wed Apr  7 17:25:57 2021) by ROOT version 6.19/01
   ...
   TPaveLabel *pl = new TPaveLabel(0.1,0.95,0.9,0.98,"Au+Au, 10-40%, UrQMD, reconstructed (GEANT4)","br");
   pl->SetBorderSize(0);
   pl->SetFillColor(0);
   pl->SetTextFont(42);
   pl->SetTextSize(2);
...
// ------------>Primitives in pad: can_1
   ...
   can_1->Draw();
   can_1->cd();
   can_1->Range(-1.231967,-0.01,3.15,0.13);
   ...
   TH2F *pad_1__1 = new TH2F("pad_1__1","",1,-0.15,3.15,1,-0.01,0.13);
   pad_1__1->SetStats(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.205,0.1235,"v_{2}{4}");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.13);
   tex->SetLineWidth(2);
   ...
   entry->SetTextFont(42);
   leg->Draw();
      tex = new TLatex(2.0475,0.1014,"#sqrt{s_{NN}}=7.7 GeV");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.13);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: can_6
   ...
   can_6->Draw();
   can_6->cd();
   can_6->Range(-1.231967,-0.054,3.15,0.13);
   ...
   TH2F *pad_6__2 = new TH2F("pad_6__2","",1,-0.15,3.15,1,-0.01,0.13);
   pad_6__2->SetStats(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.0475,0.1014,"#sqrt{s_{NN}}=11 GeV");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.105);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: can_2
   ...
   can_2->Draw();
   can_2->cd();
   can_2->Range(-0.15,-0.01,3.15,0.13);
   ...
   TH2F *pad_2__3 = new TH2F("pad_2__3","",1,-0.15,3.15,1,-0.01,0.13);
   pad_2__3->SetStats(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.205,0.1235,"v_{2}{2}");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.13);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: can_7
   ...
   can_7->Draw();
   can_7->cd();
   can_7->Range(-0.15,-0.054,3.15,0.13);
   ...
   TH2F *pad_7__4 = new TH2F("pad_7__4","",1,-0.15,3.15,1,-0.01,0.13);
   pad_7__4->SetStats(0);
...
// ------------>Primitives in pad: can_3
   ...
   can_3->Draw();
   can_3->cd();
   can_3->Range(-0.15,-0.01,3.15,0.13);
   ...
   TH2F *pad_3__5 = new TH2F("pad_3__5","",1,-0.15,3.15,1,-0.01,0.13);
   pad_3__5->SetStats(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.205,0.1235,"v_{2}^{EP}{#Psi_{2,TPC}}");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.13);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: can_8
   ...
   can_8->Draw();
   can_8->cd();
   can_8->Range(-0.15,-0.054,3.15,0.13);
   ...
   TH2F *pad_8__6 = new TH2F("pad_8__6","",1,-0.15,3.15,1,-0.01,0.13);
   pad_8__6->SetStats(0);
...
// ------------>Primitives in pad: can_4
   ...
   can_4->Draw();
   can_4->cd();
   can_4->Range(-0.15,-0.01,3.15,0.13);
   ...
   TH2F *pad_4__7 = new TH2F("pad_4__7","",1,-0.15,3.15,1,-0.01,0.13);
   pad_4__7->SetStats(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.205,0.1235,"v_{2}^{SP}{Q_{2,TPC}}");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.13);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: can_9
   ...
   can_9->Draw();
   can_9->cd();
   can_9->Range(-0.15,-0.054,3.15,0.13);
   ...
   TH2F *pad_9__8 = new TH2F("pad_9__8","",1,-0.15,3.15,1,-0.01,0.13);
   pad_9__8->SetStats(0);
...
// ------------>Primitives in pad: can_5
   ...
   can_5->Draw();
   can_5->cd();
   can_5->Range(-0.15,-0.01,3.15,0.13);
   ...
   TH2F *pad_5__9 = new TH2F("pad_5__9","",1,-0.15,3.15,1,-0.01,0.13);
   pad_5__9->SetStats(0);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(2.205,0.1235,"v_{2}^{EP}{#Psi_{1,FHCal}}");
   tex->SetTextAlign(33);
   tex->SetTextFont(42);
   tex->SetTextSize(0.13);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: can_10
   ...
   can_10->Draw();
   can_10->cd();
   can_10->Range(-0.15,-0.054,3.15,0.13);
   ...
   TH2F *pad_10__10 = new TH2F("pad_10__10","",1,-0.15,3.15,1,-0.01,0.13);
