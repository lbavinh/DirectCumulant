...
sprintf(path1,"./v2methods27ptCent20-30.txt");
sprintf(path2,"./v2methods27ptCent20-30.txt");
sprintf(path3,"./v2methods27ptCent20-30.txt");
...
TLatex *   tex = new TLatex(1.5,1.3,"Au+Au at #sqrt{s_{NN}} = 27  GeV");
   tex->SetLineWidth(2);
...
gr3->Draw("PZ");
 ...
 TLatex *   tex2 = new TLatex(1.5,0.27,"Au+Au at #sqrt{s_{NN}} = 27  GeV");
   tex2->SetLineWidth(2);
