...
char inFileName[400]={"../ROOTFile/UrQMD_4.5GeV.root"};
TFile *outFile = new TFile("../CompareResult/v2_UrQMD_4.5GeV.root","recreate");
TString outDirName={"UrQMD_4.5GeV"};
char level[400]={"UrQMD, Au+Au@#sqrt{s_{NN}}=4.5 GeV"};
