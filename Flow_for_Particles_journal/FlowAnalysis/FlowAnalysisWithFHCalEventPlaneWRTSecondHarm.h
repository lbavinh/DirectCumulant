#ifndef FLOWANALYSISWITHFHCALEVENTPLANEWRTSECONDHARM_H
#define FLOWANALYSISWITHFHCALEVENTPLANEWRTSECONDHARM_H
#include <iostream>
#include <TFile.h>
#include <TMath.h>
#include <TVector3.h>
...
class FlowAnalysisWithFHCalEventPlaneWRTSecondHarm
{
public:
  FlowAnalysisWithFHCalEventPlaneWRTSecondHarm();
  virtual ~FlowAnalysisWithFHCalEventPlaneWRTSecondHarm();
  void Init();
...
private:
  ...
  ClassDef(FlowAnalysisWithFHCalEventPlaneWRTSecondHarm,0);
