...
TString input2  = Form("../SecondRun_%s_new.root",energy.Data());
void PlotV2DifferentialChargedHadrons_testNewWeight(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_v2{LYZ,Prod}_at_%s_testNewWeight.png",energy.Data()));
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_v2{LYZ,Prod}_at_%s_testNewWeight.pdf",energy.Data()));
