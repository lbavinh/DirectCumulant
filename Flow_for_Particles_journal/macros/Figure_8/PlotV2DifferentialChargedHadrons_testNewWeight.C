...
void PlotV2DifferentialChargedHadrons_testNewWeight()
{
  ...
  {
    TString input1 = Form("../FirstRun_%s_new.root",energy[ien].Data());
    TString input2  = Form("../SecondRun_%s_new.root",energy[ien].Data());
  ...
  TPaveLabel* label = new TPaveLabel(0.1,0.95,0.9,0.99,Form("AMPT SM, #it{#sigma}_{p}=1.5 mb, Au+Au, Charged Hadrons"));//at 
  ...
  for (int ic=firstCentToDraw; ic<firstCentToDraw+numberOfCentToDraw; ic++)
  {
    ...
    {
      vGr2[ic].at(ratioToMethod)->GetYaxis()->SetTitleSize(titleSize+0.015);
      vGr2[ic].at(ratioToMethod)->GetYaxis()->SetLabelSize(labelSize+0.015);
      vGr2[ic].at(ratioToMethod)->GetYaxis()->SetTitleFont(textFont);
      vGr2[ic].at(ratioToMethod)->GetYaxis()->SetLabelFont(textFont);
      vGr2[ic].at(ratioToMethod)->GetXaxis()->SetTitleSize(titleSize+0.015);
      vGr2[ic].at(ratioToMethod)->GetXaxis()->SetLabelSize(labelSize+0.015);
      vGr2[ic].at(ratioToMethod)->GetXaxis()->SetTitleFont(textFont);
      vGr2[ic].at(ratioToMethod)->GetXaxis()->SetLabelFont(textFont);
  ...
  can->SaveAs(Form("V2pT_LYZ_AMPT_testNewWeight.png"));
  can->SaveAs(Form("V2pT_LYZ_AMPT_testNewWeight.pdf"));
