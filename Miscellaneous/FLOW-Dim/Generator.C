...
void generator(const char *OUTfile_name = "~/FLOW5/OUT/Vin1nonflowNEW.root", int run0 = 100000, TString glauberFileName = "./merge_hist_glaub_200gev.root", int nonflow = 0, float nonflowrate = 0, int aceptance = 0)
{
