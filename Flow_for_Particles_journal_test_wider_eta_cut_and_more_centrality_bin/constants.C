...
const Int_t ncent = 16;
const Double_t bin_cent[ncent + 1] = {0, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80};
...
const Double_t etaBin[netaBin+1] = {-2.5, -2.0, -1.7, -1.5, -1.0, -0.5, -0.25, -0.05, 0.0, 0.05, 0.25, 0.5, 1.0, 1.5, 1.7, 2.0, 2.5};
