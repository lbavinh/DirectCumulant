#!/bin/bash
# 47;23;23 4.5;11.5;7.7 980;992;435
export energy=7.7
export model=UrQMD
...
split -l23 -d /weekly/$USER/$working_dir/split/runlist_${model}_${energy}.list /weekly/$USER/$working_dir/split/${model}_${energy}/runlist_${model}_${energy}_
