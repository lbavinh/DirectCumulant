...
Int_t nbin=100;
const Float_t pi=3.1415926, pi2=pi/2.0, pi3=pi/3.0, pi4=pi/4.0, pi6=pi/6.0, pi8=pi/8.0;


TH2D * angles1 = new TH2D("angles1", "nwAB=2", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles2 = new TH2D("angles2", "nwAB=3", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles3 = new TH2D("angles3", "nwAB=4", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles4 = new TH2D("angles4", "nwAB=5", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles5 = new TH2D("angles5", "nwAB=6", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles6 = new TH2D("angles6", "nwAB=10", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles7 = new TH2D("angles7", "nwAB=20", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles8 = new TH2D("angles8", "nwAB=50", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles9 = new TH2D("angles9", "nwAB=100", nbin,-pi2,pi2,nbin,-pi8,pi8);
TH2D * angles10 = new TH2D("angles10", "nwAB=200", nbin,-pi2,pi2,nbin,-pi8,pi8);
...
if (phir4<-pi8)phir4=phir4+pi4;
if (phir4>pi8)phir4=phir4-pi4;

angles1->Fill(phir,phir4);
}
...
angles10->SetYTitle("#Psi_{4}");
angles10->Draw("colz");
sprintf(tt,"#rho=%.4f",angles10->GetCorrelationFactor());
   t->DrawLatex(tA,tB,tt);
   
c2->SaveAs("nwAB_psi2_psi4_42_CuAu.eps");
