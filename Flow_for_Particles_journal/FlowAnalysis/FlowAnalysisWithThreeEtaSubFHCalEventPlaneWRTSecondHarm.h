#ifndef FLOWANALYSISWITHTHREEETASUBFHCALEVENTPLANEWRTSECONDHARM_H
#define FLOWANALYSISWITHTHREEETASUBFHCALEVENTPLANEWRTSECONDHARM_H
#include <iostream>
#include <TFile.h>
#include <TMath.h>
#include <TVector3.h>
...
class FlowAnalysisWithThreeEtaSubFHCalEventPlaneWRTSecondHarm
{
public:
  FlowAnalysisWithThreeEtaSubFHCalEventPlaneWRTSecondHarm();
  virtual ~FlowAnalysisWithThreeEtaSubFHCalEventPlaneWRTSecondHarm();
  void Init();
...
private:
  ...
  ClassDef(FlowAnalysisWithThreeEtaSubFHCalEventPlaneWRTSecondHarm,0);
