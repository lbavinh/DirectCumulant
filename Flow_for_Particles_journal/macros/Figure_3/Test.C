...
void Test(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  for (int ic=firstCentToDraw; ic<firstCentToDraw+numberOfCentToDraw; ic++)
  {
    ...
    can->cd(padID);
    vGr_ratio[ic].at(0)->Draw("AP PLC PMC");
    if (ic==firstCentToDraw)
    {
    vGr_ratio[ic].at(0)->GetYaxis()->SetTitleSize(titleSize);
    vGr_ratio[ic].at(0)->GetYaxis()->SetLabelSize(labelSize);
    vGr_ratio[ic].at(0)->GetYaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(0)->GetYaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(0)->GetXaxis()->SetTitleSize(titleSize);
    vGr_ratio[ic].at(0)->GetXaxis()->SetLabelSize(labelSize);
    vGr_ratio[ic].at(0)->GetXaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(0)->GetXaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(0)->GetYaxis()->SetTitleOffset(titleOffSet);
    vGr_ratio[ic].at(0)->GetXaxis()->SetTitleOffset(1.);
    vGr_ratio[ic].at(0)->GetXaxis()->SetLabelOffset(0.017);
    tex.SetTextSize(titleSize);
    }
    else
    {
    vGr_ratio[ic].at(0)->GetYaxis()->SetTitleSize(titleSize+0.015);
    vGr_ratio[ic].at(0)->GetYaxis()->SetLabelSize(labelSize+0.015);
    vGr_ratio[ic].at(0)->GetYaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(0)->GetYaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(0)->GetXaxis()->SetTitleSize(titleSize+0.015);
    vGr_ratio[ic].at(0)->GetXaxis()->SetLabelSize(labelSize+0.015);
    vGr_ratio[ic].at(0)->GetXaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(0)->GetXaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(0)->GetYaxis()->SetTitleOffset(titleOffSet-0.1);
    vGr_ratio[ic].at(0)->GetXaxis()->SetTitleOffset(0.8);
    tex.SetTextSize(titleSize+0.015);
    }
    ...
    vGr_ratio[ic].at(0)->SetTitle(Form(";#it{p}_{T}, GeV/c;Ratio to %s", title[ratioToMethod].Data()));
