...
TFile *outFile = new TFile("../CompareResult/VinhPID_UrQMD_merged_ACS.root","recreate");
TString outDirName={"UrQMD_merged_ACS"};
...
void v2plot_differential_flow(){
  TFile *inFile = new TFile("../ROOTFile/PID_only_charged_eta_0.05_1.5_pt_0.2_3.0_ACS.root","read");
  ...
  */
  ...
  double eV22Dif1040CH[npt]={4.74564e-05,6.29115e-05,8.90256e-05,0.000124994,0.000172447,0.000207406,0.000330627,0.00046561,0.00167394};
  double eV22Dif1040Pion[npt]={5.02608e-05,7.29182e-05,0.000115432,0.000182942,0.000277515,0.000358668,0.000607088,0.000943545,0.0041893};
  double eV22Dif1040Kaon[npt]={0.000247416,0.000241376,0.000294875,0.000384224,0.000511439,0.000627299,0.00105957,0.00166879,0.00766911};
  double eV22Dif1040Proton[npt]={0.000249602,0.000178473,0.000166049,0.000181311,0.000220973,0.000251139,0.000404122,0.000565168,0.00201881};
    
  double eV24Dif1040CH[npt]={0.000405314,0.000520862,0.000683155,0.000915328,0.00122669,0.00145388,0.00221493,0.00301359,0.00999907};
  double eV24Dif1040Pion[npt]={0.000427764,0.000600124,0.000860317,0.00127788,0.00185374,0.00234115,0.00380333,0.00573861,0.0252261};
  double eV24Dif1040Kaon[npt]={0.00163025,0.00158957,0.0019259,0.00246141,0.00320505,0.00387784,0.00636818,0.00979979,0.0441123};
  double eV24Dif1040Proton[npt]={0.00166097,0.00120598,0.00113637,0.00125814,0.00153152,0.0017336,0.00268122,0.00363016,0.0120475};

  double eV2EPDif1040CH[npt]={6.15531e-05,7.91047e-05,0.000103834,0.000135693,0.00017983,0.000214218,0.000358036,0.000536038,0.00225038};
  double eV2EPDif1040Pion[npt]={6.50827e-05,9.1754e-05,0.000137882,0.00020824,0.00031201,0.00041272,0.000758546,0.00123504,0.00569064};
  double eV2EPDif1040Kaon[npt]={0.000267756,0.000261182,0.000322543,0.000435744,0.000611241,0.000777257,0.00139573,0.00225362,0.0105503};
  double eV2EPDif1040Proton[npt]={0.000280567,0.000203821,0.0001896,0.000205985,0.000248393,0.000279991,0.000451355,0.000660046,0.00271649};
  ...
  for (int id=0;id<npid;id++){
    ...
    cV2PT1040[id] = (TCanvas*) DrawTGraph(vgrv2pt1040,"",0.77, 1.23,    0.,maxpt,-0.01,0.2,     0.18,0.56,0.5,0.8,hname);
