void Compare_vsBimp()
{
  ...
  int marker[]={21,20,22};
  TFile *fV2   = new TFile("v2_UrQMD_7.7GeV_vsBimp.root","read");
  TFile *fEcc2 = new TFile(Form("ecc_%s_7.7GeV_vsBimp.root",modelInitialEccentricity.Data()),"read");
  ...
  grRatioV2[1]->SetTitle(";b, fm;#epsilon_{2}{4}/#epsilon_{2}{2}, v_{2}{4}/v_{2}{2}");
  c.SaveAs(Form("Flow_Eccentricity_(%s)_Fluctuations_vs_Bimp.png",modelInitialEccentricity.Data()));
