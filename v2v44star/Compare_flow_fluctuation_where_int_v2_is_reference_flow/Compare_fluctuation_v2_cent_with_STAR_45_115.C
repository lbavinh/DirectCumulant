void Compare_fluctuation_v2_cent_with_STAR_45_115(){
  ...
  // //=================================================================================
    can->cd(3);
    TH2F *h3 = new TH2F("h2",";centrality [%];v_{2}{4}/v_{2}{2}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  // leg_pt4->Draw();
  // lineOne.DrawLine(minpt,1.,maxpt,1.);
  can->SaveAs("ratiov2cent_vsSTAR_3ener_v24_v22_merge.eps");
