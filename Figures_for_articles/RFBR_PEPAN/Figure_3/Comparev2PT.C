void Comparev2PT(){ // 0: v22; 1:v24; 2: v2EP, 3: gapped v22
  ...
  TString graphTitle[]={"v_{2}{4}","v_{2}^{EP}{#Psi_{2,TPC}}","v_{2}{2}","v_{2}^{SP}{Q_{2,TPC}}","v_{2}^{EP}{#Psi_{1,FHCal}}"};
  ...
  TPaveLabel* title = new TPaveLabel(0.1,0.95,0.9,0.98,"Au+Au, 10-40%, UrQMD, reconstructed (GEANT4), Ch. hadrons");
