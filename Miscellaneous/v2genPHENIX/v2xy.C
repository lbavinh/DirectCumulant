...
(void) sprintf(hname1,"hv2x_%i_%i",it,0);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2X[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2Xe[it]=err/res2rxn;
...
(void) sprintf(hname1,"hv2y_%i_%i",it,0);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2Y[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2Ye[it]=err/res2rxn;
...
(void) sprintf(hname1,"hv2x_%i_%i",it,1);
TH1F *h3 = (TH1F*) file->Get(hname1);
m2X[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
m2Xe[it]=err/res2rxn;
...
(void) sprintf(hname1,"hv2y_%i_%i",it,1);
TH1F *h3 = (TH1F*) file->Get(hname1);
m2Y[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
m2Ye[it]=err/res2rxn;
...
(void) sprintf(hname1,"hv2x_%i_%i",it,2);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2XW[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2XWe[it]=err/res2rxn;



(void) sprintf(hname1,"hv2y_%i_%i",it,2);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2YW[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2YWe[it]=err/res2rxn;



(void) sprintf(hname1,"hv2x_%i_%i",it,3);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2XE[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2XEe[it]=err/res2rxn;



(void) sprintf(hname1,"hv2y_%i_%i",it,3);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2YE[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2YEe[it]=err/res2rxn;
...
(void) sprintf(hname1,"hv2x_%i_%i",it,4);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2XTW[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2XTWe[it]=err/res2rxn;



(void) sprintf(hname1,"hv2y_%i_%i",it,4);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2YTW[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2YTWe[it]=err/res2rxn;
...
(void) sprintf(hname1,"hv2x_%i_%i",it,5);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2XTE[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2XTEe[it]=err/res2rxn;



(void) sprintf(hname1,"hv2y_%i_%i",it,5);
TH1F *h3 = (TH1F*) file->Get(hname1);
v2YTE[it]=(h3->GetMean())/res2rxn;
float rms=(h3->GetRMS());
int nent=(h3->GetEntries());
float err =rms/sqrt(nent);
v2YTEe[it]=err/res2rxn;
...
P1[it]=v2X[it]/v2[it];
EP1[it]=sqrt((v2e[it]*v2e[it])/(v2[it]*v2[it])+(v2Xe[it]*v2Xe[it])/(v2X[it]*v2X[it]))*P1[it];

P2[it]=v2Y[it]/v2[it];
EP2[it]=sqrt((v2e[it]*v2e[it])/(v2[it]*v2[it])+(v2Xe[it]*v2Xe[it])/(v2X[it]*v2X[it]))*P2[it];


P3[it]=m2X[it]/v2[it];
EP3[it]=sqrt((v2e[it]*v2e[it])/(v2[it]*v2[it])+(v2Xe[it]*v2Xe[it])/(v2X[it]*v2X[it]))*P3[it];

P4[it]=m2Y[it]/v2[it];
EP4[it]=sqrt((v2e[it]*v2e[it])/(v2[it]*v2[it])+(v2Xe[it]*v2Xe[it])/(v2X[it]*v2X[it]))*P4[it];
 ...
 c1->GetFrame()->SetBorderSize(12);
  ...
  // const int npt=7;
 gr1 = new TGraphErrors(24,hpt,P1,hpte,EP1);
 ...
 gr1->Draw("P");
  ...
  // const int npt=7;
 gr2 = new TGraphErrors(24,hpt,P2,hpte,EP2);
 ...
 gr2->Draw("P");
  ...
  // const int npt=7;
 gr3 = new TGraphErrors(24,hpt,P3,hpte,EP3);
 ...
 gr3->Draw("P");
  ...
  // const int npt=7;
 gr4 = new TGraphErrors(24,hpt,P4,hpte,EP4);
...
c2 = new TCanvas("c2","Flow analysis results",200,10,700,550);
 ...
 c2->GetFrame()->SetBorderSize(12);
  ...
  TH2F *hr2 = new TH2F("hr2","V_{2}[ACC] / V_{2}{GEN} vs p_{T}", 2,xmin1,xmax1,2,ymin1,ymax1);
