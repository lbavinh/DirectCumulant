...
TString inputFileName = "QCumulant_Nhits_16_3_sigma_v3.root";
...
const int binMaxPtRFP = 6; // 2.8 GeV
...
void PlotV2QCumulant(TString model = "AMPT08", TString energy = "7.7GeV"){
