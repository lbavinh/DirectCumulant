void RatioV24V22vsPt_1020(){
  ...
  TPaveLabel* title = new TPaveLabel(0.1,0.97,0.9,0.985,"Au+Au, 10-20%, Ch. hadrons");
  ...
  can->SaveAs("Figure_Ratiov24v22_vs_pt_10-20.pdf");
  gROOT->SetStyle("Pub");
  can->SaveAs("Figure_Ratiov24v22_vs_pt_10-20.png");
