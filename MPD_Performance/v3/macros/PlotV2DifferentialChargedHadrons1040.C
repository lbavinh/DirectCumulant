...
#include "constants.C"
void PlotV2DifferentialChargedHadrons1040(TString inputFileName = "../data/SecondRun_Model.root")
{
  Bool_t saveAsPNG = true;
  TString outDirName = "Model";
  ...
  TString title[]={"v_{3}{#Psi_{3,TPC}}","v_{3}^{SP}{Q_{3,TPC}}","v_{3}{#Psi_{1,FHCal}}","v_{3}{#Psi_{3,3-sub}}"};
