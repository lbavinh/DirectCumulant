...
void v2plot_differential_flow(){
  ...
  */
  ...
  const char *grTitleDF[]={"[3]v_{2}{2,QC};p_{T} [GeV/c];v_{2}",
                           "[2] v_{2}{4};p_{T} [GeV/c];v_{2}",
                           "[1] v_{2}{2};p_{T} [GeV/c];v_{2}"};
  outFile -> cd();
...
void v2plot_integrated_flow_for_CH(){ // v2int = v2 reference
  ...
  const char *grTitle[]={"[3]v_{2}{2};centrality (%);v_{2}",
                         "[2] v_{2}{4};centrality (%);v_{2}",
                         "[1] v_{2}{2,Gapped};centrality (%);v_{2}"};
  outFile -> cd();
  for (int imeth=0; imeth<nmethod; imeth++){
...
void v2plot_integrated_flow_for_PID(){ 
  ...
  for (int id=0;id<npid;id++){
    ...
    grIntFlowVsCent[2][id] = new TGraphErrors(ncent,bin_cent,&vV22Gapint[0],bin_centE,&eV22Gap[0]);
    // grIntFlowVsCent[2][id] = new TGraphErrors(ncent,bin_cent,&vV2EPint[0],bin_centE,&eV2EP[0]); 
