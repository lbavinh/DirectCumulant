...
void plot(TString model ="UrQMD", TString energy = "7.7GeV") {
  ...
  // Histogram input
  TProfile *prEcc22 = (TProfile*)inFile->Get(Form("prEcc226"));
  TProfile *prEcc24 = (TProfile*)inFile->Get(Form("prEcc246"));
  TProfile *prCov24 = (TProfile*)inFile->Get(Form("prCov246"));
  TProfile *ecc2vsCent = (TProfile *) inFile -> Get("prEcc2vsCent6");
