...
void res2() {
  ...
  TFile *file = new TFile("/weekly/nikolaev/lbavinh/EventPlane/OUT/nonflow_0.2rate/res2.root","read");
  ...
  for (int ic = 0; ic < ncent; ic++) {
    (void)sprintf(hname1, "HRes_cent%i", ic); // Res of 2nd harmonic, TPC, ic-th cent bin
    TH1F *h3 = (TH1F *)file->Get(hname1);
    res2EW[ic] = sqrt(h3->GetMean());
    eres[ic] = 0.01;
    ecent[ic] = 0.03;
