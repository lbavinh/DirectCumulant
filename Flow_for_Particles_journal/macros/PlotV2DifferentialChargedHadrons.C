...
vector<TGraphErrors*>* PlotV2DifferentialChargedHadrons(TString inputFirstRunFileName = "FirstRun_11.5.root", TString inputSecondRunFileName = "SecondRun_11.5.root")
{
