...
void PlotV2IntegratedChargedHadronsTwoEnergy()
{
  ...
  vGr77_ratio.at(ratioToMethod-5)->GetYaxis()->SetLabelFont(textFont);
  vGr77_ratio.at(ratioToMethod-5)->GetXaxis()->SetTitleSize(titleSize);
  vGr77_ratio.at(ratioToMethod-5)->GetXaxis()->SetLabelSize(labelSize);
  vGr77_ratio.at(ratioToMethod-5)->GetXaxis()->SetTitleFont(textFont);
  vGr77_ratio.at(ratioToMethod-5)->GetXaxis()->SetLabelFont(textFont);
  vGr77_ratio.at(ratioToMethod-5)->GetYaxis()->SetTitleOffset(titleOffSet);
  ...
  vGr115_ratio.at(ratioToMethod-5)->GetYaxis()->SetLabelFont(textFont);
  vGr115_ratio.at(ratioToMethod-5)->GetXaxis()->SetTitleSize(titleSize);
  vGr115_ratio.at(ratioToMethod-5)->GetXaxis()->SetLabelSize(labelSize);
  vGr115_ratio.at(ratioToMethod-5)->GetXaxis()->SetTitleFont(textFont);
  vGr115_ratio.at(ratioToMethod-5)->GetXaxis()->SetLabelFont(textFont);  
