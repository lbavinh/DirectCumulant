...
void Performance_QC_Centrality_10_40()
{
  ...
  TString input[nmethod] = {"v2_FirstRun_vHLLEUrQMD_11.5_Model.root.root",
                            "v2_FirstRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_2sigma.root.root",
                            "v2_FirstRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_3sigma_pt_weight.root.root",
                            "v2_FirstRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_4sigma_pt_weight.root.root"};
  ...
  TString title[]={"Model","Reco, 2#sigma_{DCA}","Reco, 3#sigma_{DCA}","Reco, 4#sigma_{DCA}"};// MC GEANT4 Reco
  ...
  can->SaveAs(Form("Performance_v2_2QC_1040_Model_vs_Reco_Nhits_16_%s_DCA_sigma_2_3_4.pdf",pidName[ic].Data()));
  }
