void ThreeEnergies(){
  ...
  for (int ien=0;ien<nenergy;ien++){
    ...
    grRatioV2[ien][3] -> SetMarkerColor(kRed+3);
    grRatioV2[ien][3] -> SetLineColor(kRed+3);
    ...
    grRatioV2[ien][6] -> SetMarkerColor(kGray+2);
    grRatioV2[ien][6] -> SetLineColor(kGray+2);
    grRatioV2[ien][6] -> SetMarkerStyle(kOpenDiamond);
  ...
  can->SaveAs("v24v22Cent_4_11GeV_Models_vs_STAR.pdf");
  gROOT->SetStyle("Pub");
  can->SaveAs("v24v22Cent_4_11GeV_Models_vs_STAR.png");
