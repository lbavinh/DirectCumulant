...
#$ -o /weekly/nikolaev/lbavinh/DirectCumulant/TMP
#$ -e /weekly/nikolaev/lbavinh/DirectCumulant/TMP
#
...
#Main directory
export MAIN_DIR=/weekly/nikolaev/lbavinh/DirectCumulant
...
echo "---------------" &>> $LOG
echo "Run QC calculation..." &>> $LOG
root -l -b -q $MAIN_DIR/macro.C+ &>> $LOG
