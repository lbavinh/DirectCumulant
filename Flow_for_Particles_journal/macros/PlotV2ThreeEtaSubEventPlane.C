#define PLOTV2THREEETASUBEP
// bool bDebug = false;
TProfile *PlotV2ThreeEtaSubEPIntegrated(TProfile3D* &prV2,
...
TProfile *PlotV2ThreeEtaSubEPDifferentialVersusPt(TProfile3D *const &prV2,
...
TProfile *PlotV2ThreeEtaSubEPDifferentialVersusEta(TProfile3D*const &prV2,
                           const double pt_low = 0.2,
                           const double pt_high = 3.0,
                           const double cent_low = 10,
                           const double cent_high = 40)
...
void PlotV2ThreeEtaSubEventPlane(TString inputFileName = "SecondRun.root")
{
  TFile *fi = TFile::Open(inputFileName.Data());
  TProfile3D *pr = (TProfile3D *)fi->Get("prV2ThreeEtaSub");
  ...
  TProfile *prV2diffpt = PlotV2ThreeEtaSubEPDifferentialVersusPt(pr,10,40,1.5);
  ...
  TProfile *prV2diffpt4080 = PlotV2ThreeEtaSubEPDifferentialVersusPt(pr,40,80,1.5);
  ...
  TProfile *prV2int = PlotV2ThreeEtaSubEPIntegrated(pr,0.2,3.5,1.5);
