...
void PlotV2IntegratedChargedHadronsTwoEnergy_testNewWeight_AMPT08()
{
  ...
  const int markerStyle[] = {24,22,23,20,30,27,26,25,32};
  ...
  vector<TGraphErrors*> vGr115 = PlotV2IntegratedChargedHadrons("../FirstRun_AMPT08_11.5_new.root","../SecondRun_AMPT08_11.5_new.root");
  ...
  Green(vGr77.at(3));
  Green(vGr115.at(3));
  Green(vGr77_ratio.at(3));
  Green(vGr115_ratio.at(3));
  ...
  Red(vGr77.at(7));
  Red(vGr115.at(7));
  Red(vGr77_ratio.at(7));
  Red(vGr115_ratio.at(7));

  TCanvas *can = new TCanvas("can","",1000,600);
  TPaveLabel* label = new TPaveLabel(0.1,0.95,0.9,0.99,Form("AMPT SM, #it{#sigma}_{p}=0.8 mb, Au+Au, Charged Hadrons, 0.2< #it{p}_{T}<3.0 GeV/c"));
  ...
  can->SaveAs("V2Cent_Others_AMPT08_testNewWeight.png");
  can->SaveAs("V2Cent_Others_AMPT08_testNewWeight.pdf");
