...
void FMoments_and_Absolute_Fluctuations_vsCent_7GeV_Glissando()
{
  const int ncent = 9;
  ...
  TFile *fiEcc = new TFile("Glissando_7.7GeV.root","read");
  ...
  l->AddEntry(grStdDevScaled,Form("%s\\ (Glissando)",grStdDevScaled->GetTitle()),"l");
  l->AddEntry(grFMomentsEcc2[1],Form("%s\\ (Glissando)",grFMomentsEcc2[1]->GetTitle()),"p");
  ...
  c.SaveAs("FMoments_and_Absolute_Fluctuations_vsCent_7GeV_Glissando.png");
