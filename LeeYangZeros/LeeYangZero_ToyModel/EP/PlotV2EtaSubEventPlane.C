...
void PlotV2EtaSubEventPlane(TString inputFileName = "test1.root")
{
  ...
  c.cd(1);
  // v2 versus pt, 10-40%, |eta|<2.0
  TProfile *prV2diffpt = PlotV2DifferentialVersusPt(pr,10,40,2.0);
  ...
  c.cd(2);
  // v2 versus pt, 40-80%, |eta|<2.0
  TProfile *prV2diffpt4080 = PlotV2DifferentialVersusPt(pr,40,80,2.0);
  ...
  c.cd(3);
  // v2 versus centrality, 0.2<pt<3.5 GeV/c, |eta|<2.0
  TProfile *prV2int = PlotV2Integrated(pr,0.2,3.5,2.0);
