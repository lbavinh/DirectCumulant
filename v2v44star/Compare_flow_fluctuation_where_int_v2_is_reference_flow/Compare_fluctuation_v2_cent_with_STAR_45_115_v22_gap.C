void Compare_fluctuation_v2_cent_with_STAR_45_115_v22_gap(){
  ...
  for (int imod=1;imod<nmodel;imod++){
    ...
    if (imod!=1)grRatioV2[0][imod] -> SetMarkerStyle(kFullCircle);
  ...
  for (int iener=1;iener<nenergy;iener++){
    FILE *fp1;
    char path1[800];
    sprintf(path1,"./v2methods%sCent.txt",energySTAR[iener-1].Data());
    ...
    grRatioV2[iener][0] -> SetTitle(Form("STAR data;centrality [%];v_{2}{4}/v_{2}{2,|#Delta#eta|>0.1}"));
  ...
  //=================================================================================
  can->cd(1);
  TH2F *h1 = new TH2F("h1",";centrality [%];v_{2}{4}/v_{2}{2,|#Delta#eta|>0.1}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  //=================================================================================
  can->cd(2);
  TH2F *h2 = new TH2F("h2",";centrality [%];v_{2}{4}/v_{2}{2,|#Delta#eta|>0.1}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  // //=================================================================================
    can->cd(3);
    TH2F *h3 = new TH2F("h2",";centrality [%];v_{2}{4}/v_{2}{2,|#Delta#eta|>0.1}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  // //=================================================================================
  // can->cd(4);
  // TH2F *h4 = new TH2F("h4",";centrality [%];v_{2}{4}/v_{2}{2,|#Delta#eta|>0.1}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  // leg_pt4->Draw();
  // lineOne.DrawLine(minpt,1.,maxpt,1.);
  can->SaveAs("ratiov2cent_vsSTAR_3ener_v24_v22gap_merge.eps");
