...
vector<TGraphErrors*> PlotV2DifferentialChargedHadronsFor10_40Centrality_115(TString inputFirstRunFileName = "FirstRun_11.5.root", TString inputSecondRunFileName = "SecondRun_11.5.root")
{
...
const double v22Gape1040[16] = {3.92803e-05, 2.64279e-05, 3.94995e-05, 6.26968e-05, 9.82472e-05, 0.000149224, 0.000219468, 0.000321131, 0.000481703, 0.000748301, 0.00119025, 0.00190278, 0.003032, 0.00482949, 0.00638477, 0.0155447};
  ...
  can->SaveAs("DiffFlow_AMPT_11.5_10-40%_v24_versus_v2LYZ.pdf");
