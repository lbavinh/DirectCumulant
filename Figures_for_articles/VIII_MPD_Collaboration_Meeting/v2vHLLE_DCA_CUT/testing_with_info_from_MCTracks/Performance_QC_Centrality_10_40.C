...
void Performance_QC_Centrality_10_40()
{
  ...
  TString input[nmethod] = {"v2_FirstRun_vHLLEUrQMD_11.5_Model.root.root",
                            "v2_FirstRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_3sigma_PID_from_MCTracks.root.root",
                            "v2_FirstRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_3sigma_pt_from_MCTracks.root.root",
                            "v2_FirstRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_3sigma_pt_from_MCTracks_PID_from_MCTracks.root.root"};
  ...
  TString title[]={"Model","p_{T} from Reco Tracks","PID: TOF+TPC","3#sigma_{DCA}"};// MC GEANT4 Reco

  const int markerStyle[] = {24,23,23,23,20,25,28,26,23};
  ...
  can->SaveAs(Form("Performance_v2_2QC_1040_Model_vs_Reco_pt_PID_from_MCTracks_%s.pdf",pidName[ic].Data()));
  }
