...
char inFileName[400]={"../ROOTFile/UrQMD_7.7GeV.root"};
TFile *outFile = new TFile("../CompareResult/v2_UrQMD_7.7GeV.root","recreate");
TString outDirName={"UrQMD_7.7GeV"};
...
vector<pair<Double_t,Double_t>> rangeRatio = {{0.89,1.11},{0.89,1.11},{0.89,1.11},{0.89,1.11},{0.89,1.11},{0.89,1.11},{0.89,1.11},{0.89,1.11},{0.84,1.16}};
