...
void PlotV2DifferentialChargedHadrons(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_v2{LYZ,Prod}_at_%s.png",energy.Data()));
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_v2{LYZ,Prod}_at_%s.pdf",energy.Data()));
