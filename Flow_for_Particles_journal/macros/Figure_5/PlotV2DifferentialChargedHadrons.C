...
void PlotV2DifferentialChargedHadrons(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  bool bUseProduct = 1;
  Int_t nmethod = 8;
  TString title[]={"#it{v}_{2}{#Psi_{2,TPC}}","#it{v}_{2}^{SP}{Q_{2,TPC}}","#it{v}_{2}{2,#eta-gap}","#it{v}_{2}{2}","AMPT, #it{#sigma}_{p}=1.5 mb","#it{v}_{2}{LYZ, Sum}","#it{v}_{2}{LYZ}","STAR"};
  ...
  const double v24STAR115_10_20[16] = {0.,0.0182,0.0323,0.0404,0.0561,0.072,0.0887,0.0935,0.1108,0.1239,0.1434,0.1526,0.145,0.1404,0.1642,0.};
  const double v24eSTAR115_10_20[16] = {0.,0.0011,0.0013,0.0017,0.0023,0.003,0.0041,0.0055,0.0075,0.0104,0.0148,0.0203,0.0285,0.041,0.0455,0.};
  ...
  const double v24STAR115_30_40[16] = {0.,0.027,0.0494,0.065,0.0865,0.1037,0.1245,0.1464,0.1593,0.1488,0.1935,0.1915,0.253,0.2881,0.2939,0.};
  const double v24eSTAR115_30_40[16] = {0.,0.0015,0.0019,0.0025,0.0034,0.0046,0.0063,0.0086,0.0121,0.0166,0.0239,0.0342,0.0507,0.0655,0.0766,0.};
  ...
  graph[2][7] = new TGraphErrors(16,pTBinSTAR,v24STAR115_10_20,zeroArray,v24eSTAR115_10_20);
  graph[3][7] = new TGraphErrors(16,pTBinSTAR,v24STAR115_20_30,zeroArray,v24eSTAR115_20_30);
  graph[4][7] = new TGraphErrors(16,pTBinSTAR,v24STAR115_30_40,zeroArray,v24eSTAR115_30_40);
  // QCumulant
  ...
  for (int ic=firstCentToDraw; ic<numberOfCentToDraw+firstCentToDraw; ic++)
  {
    ...
    for (int i=0; i<vGr[ic].size(); i++)
    {
      vGr[ic].at(i)->SetTitle(";#it{p}_{T}, GeV/c;#it{v}_{2}{4}");
    }
  }
  ...
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_STAR_at_%s.png",energy.Data()));
  can->SaveAs(Form("CompareMethods_Diff_v2{4}_vs_STAR_at_%s.pdf",energy.Data()));
