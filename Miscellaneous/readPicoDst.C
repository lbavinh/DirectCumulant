...
void readPicoDst(TString inputFileName="/weekly/parfenov/mpd_winter2019/mpd_prod/7.7gev/merged/picodst_merged1_184.root", TString outputFileName="test.root")
{ // /weekly/parfenov/mpd_winter2019/mpd_prod/7.7gev/merged/picodst_merged1_184.root
  // /weekly/lbavinh/lbavinh/PicoDst/split/Reco_UrQMD_7.7/runlist_Reco_UrQMD_7.7_03.list
  TStopwatch timer;
  timer.Start();
  ...
  //     nFile++;
  // }
  // std::cout<<"Added " << nFile <<" trees to chain.\n";
