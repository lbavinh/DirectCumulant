...
void Performance(){ // 0: v22; 1:v24; 2: v2EP, 3: gapped v22
  ...
  TPaveLabel* title = new TPaveLabel(0.1,0.95,0.9,0.98,"UrQMD, Au+Au, 10-40%, reconstructed (GEANT4), Charged Hadrons");
  ...
  for (int ipad=0;ipad<10;ipad++){
    ...
    if (ipad>=5){
      ...
      h[ipad]->GetXaxis()->SetTitleSize(titleSizeLowerPlot+0.015);
