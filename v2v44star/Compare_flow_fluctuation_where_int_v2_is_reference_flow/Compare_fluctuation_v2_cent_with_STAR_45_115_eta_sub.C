void Compare_fluctuation_v2_cent_with_STAR_45_115_eta_sub(){
  ...
  for (int ien=0;ien<nenergy;ien++){
    for (int imod=1;imod<nmodel;imod++){
      ...
      grRatioV2[ien][imod] -> SetTitle(Form("%s;centrality [%];v_{2}{4}/v_{2}{#eta-sub}",model[imod].Data()));
  ...
  for (int iener=1;iener<nenergy;iener++){
    ...
    for (int ipt=0; ipt<npt; ipt++) {
      ...
      v24e[ipt]   = s24e;
      pte[ipt]    = 0.;
      Double_t ratio = s24/s2eta;
      Double_t ratioErr = ratio*(TMath::Sqrt(TMath::Power(s24e/s24,2)+TMath::Power(s2etae/s2eta,2)));
    ...
    grRatioV2[iener][0] -> SetTitle(Form("STAR data;centrality [%];v_{2}{4}/v_{2}{#eta-sub}"));
  ...
  // //=================================================================================
    can->cd(3);
    TH2F *h3 = new TH2F("h2",";centrality [%];v_{2}{4}/v_{2}{#eta-sub}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  // //=================================================================================
  // can->cd(4);
  // TH2F *h4 = new TH2F("h4",";centrality [%];v_{2}{4}/v_{2}{#eta-sub}",1,minpt,maxpt,1,minV2Ratio,maxV2Ratio);
  ...
  // leg_pt4->Draw();
  // lineOne.DrawLine(minpt,1.,maxpt,1.);
  can->SaveAs("ratiov2cent_vsSTAR_3ener_v24_v2etasub_merge.eps");
