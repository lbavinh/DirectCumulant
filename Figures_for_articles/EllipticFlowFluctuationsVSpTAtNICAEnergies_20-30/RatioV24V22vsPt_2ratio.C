void RatioV24V22vsPt_2ratio(){
  ...
  TPaveLabel* title = new TPaveLabel(0.1,0.97,0.9,0.985,"Au+Au, 20-30%, Ch. hadrons");
  ...
  can->SaveAs("Figure_Ratiov24v22_vs_pt_20-30_2ratio.pdf");
  // gROOT->SetStyle("Pub");
  can->SaveAs("Figure_Ratiov24v22_vs_pt_20-30_2ratio.png");
  // can->SaveAs("Figure_Ratiov24v22_vs_pt_20-30_2ratio.eps");
