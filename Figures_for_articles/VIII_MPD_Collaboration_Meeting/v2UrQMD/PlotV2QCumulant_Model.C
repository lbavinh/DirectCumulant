...
TGraphErrors* PlotV2QCumulant_Model(TString inFileName = "FirstRun_UrQMD_7.7.root"){
  TString model = "UrQMD"; TString energy = "7.7 GeV";
  ...
  CalStatErrCent1040(inFileName,v2eDif1040);
