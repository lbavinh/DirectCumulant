...
void PlotV2IntegratedChargedHadronsTwoEnergy_withoutLYZ()
{
  ...
  Black(vGr77.at(8));
  Black(vGr115.at(8));
  Black(vGr77_ratio.at(8));
  Black(vGr115_ratio.at(8));

  // Yellow(vGr77.at(0));
  // Yellow(vGr115.at(0));
  // Yellow(vGr77_ratio.at(0));
  // Yellow(vGr115_ratio.at(0));
  ...
  can->cd(3);
  vGr77_ratio.at(ratioToMethod-8)->Draw("AP");
  vGr77_ratio.at(ratioToMethod-8)->GetYaxis()->SetTitleSize(titleSize);
  vGr77_ratio.at(ratioToMethod-8)->GetYaxis()->SetLabelSize(labelSize);
  vGr77_ratio.at(ratioToMethod-8)->GetYaxis()->SetTitleFont(textFont);
  vGr77_ratio.at(ratioToMethod-8)->GetYaxis()->SetLabelFont(textFont);
  vGr77_ratio.at(ratioToMethod-8)->GetXaxis()->SetTitleSize(titleSize);
  vGr77_ratio.at(ratioToMethod-8)->GetXaxis()->SetLabelSize(labelSize);
  vGr77_ratio.at(ratioToMethod-8)->GetXaxis()->SetTitleFont(textFont);
  vGr77_ratio.at(ratioToMethod-8)->GetXaxis()->SetLabelFont(textFont);
  vGr77_ratio.at(ratioToMethod-8)->GetYaxis()->SetTitleOffset(titleOffSet);
  ...
  vGr77_ratio.at(ratioToMethod-8)->SetTitle(Form(";Centrality, %%;Ratio to %s", title[ratioToMethod].Data()));
  tex.SetTextSize(titleSize);
  tex.DrawLatex(3,1.08,"(c)");
  can->cd(4);
  vGr115_ratio.at(ratioToMethod-8)->Draw("AP");
  vGr115_ratio.at(ratioToMethod-8)->GetYaxis()->SetTitleSize(titleSize);
  vGr115_ratio.at(ratioToMethod-8)->GetYaxis()->SetLabelSize(labelSize);
  vGr115_ratio.at(ratioToMethod-8)->GetYaxis()->SetTitleFont(textFont);
  vGr115_ratio.at(ratioToMethod-8)->GetYaxis()->SetLabelFont(textFont);
  vGr115_ratio.at(ratioToMethod-8)->GetXaxis()->SetTitleSize(titleSize);
  vGr115_ratio.at(ratioToMethod-8)->GetXaxis()->SetLabelSize(labelSize);
  vGr115_ratio.at(ratioToMethod-8)->GetXaxis()->SetTitleFont(textFont);
  vGr115_ratio.at(ratioToMethod-8)->GetXaxis()->SetLabelFont(textFont);  
  ...
  vGr115_ratio.at(ratioToMethod-8)->SetTitle(Form(";Centrality, %%;Ratio to %s", title[ratioToMethod].Data()));
