...
void PlotV2DifferentialChargedHadrons_AMPT08(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  can->SaveAs(Form("V2pT_AMPT08_at_%s.png",energy.Data()));
  can->SaveAs(Form("V2pT_AMPT08_at_%s.pdf",energy.Data()));
