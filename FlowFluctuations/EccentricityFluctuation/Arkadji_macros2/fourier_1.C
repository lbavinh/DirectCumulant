...
TH2D *h2 = new TH2D("h2","#epsilon^{*}_{n} vs N_{W}",up,0.5,up+0.5,100,-1,1);
...
p2->SetTitle("variable-axes eccentricities, n=2,3,4,5,6");
p2->SetXTitle("N_{W} ");
p2->SetYTitle("#epsilon*_{n}  ");
...
//for (Int_t i=1;i<=up;i++){
//*out << i << "\t" << p3->GetBinContent(i)<<endl;
//}
