...
void FlowLeeYangZeros(TString inputFileName, TString outputFileName)
{
  ...
  // from 1-st run
const double res2[9] = {0.150775, 0.274214, 0.356933, 0.371619, 0.339015, 0.276114, 0.237011, 0.180015, 0.200128};
const double r02[ncent][thetabins] = {{0.213309, 0.227937, 0.221764, 0.256835, 0.267006},
{0.315517, 0.391855, 0.23746, 0.228062, 0.332979},
{0.39809, 0.311825, 0.255725, 0.259564, 0.294629},
{0.325991, 0.367321, 0.318725, 0.317273, 0.339001},
{0.39705, 0.323961, 0.34695, 0.3882, 0.357657},
{0.405647, 0.374589, 0.443333, 0.620071, 0.677043},
{0.660897, 0.659352, 0.844842, 0.650843, 0.556763},
{0.686896, 0.847372, 0, 0.726455, 0},
{0, 0, 0, 0, 0}
 };
const double chisq[9] = {0.525641, 0.442347, 0.498857, 0.538761, 0.596172, 0.530266, 0.459172, 0.536333, 0};
  ...
  for (int iEv = 0; iEv < n_entries; iEv++)
  {
    ...
    Q2x = 0.;
    Q2y = 0.;
    if (bSecondRun) for (int ipt = 0; ipt < npt; ipt++) multPOI[ipt] = 0.;
