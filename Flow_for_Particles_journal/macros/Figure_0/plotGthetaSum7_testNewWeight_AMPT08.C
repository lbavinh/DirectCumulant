...
void plotGthetaSum7_testNewWeight_AMPT08()
{
  ...
  tex.DrawLatex(55,0.01,"#splitline{AMPT SM, #it{#sigma}_{p}=0.8 mb}{Au+Au at #sqrt{#it{s}_{NN}} = 7.7 GeV}");
  
  gPad->SetLogy();
  gStyle->SetOptStat(0);
  c.SaveAs("Gtheta77_testNewWeight_AMPT08.pdf");
  c.SaveAs("Gtheta77_testNewWeight_AMPT08.png");
}
