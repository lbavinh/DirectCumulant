...
char inFileName[400]={"../ROOTFile/SMASH_7.7GeV.root"};
TFile *outFile = new TFile("../CompareResult/v2_SMASH_7.7GeV_int_over_pt.root","recreate");
TString outDirName={"SMASH_7.7GeV_int_over_pt"};
char level[400]={"SMASH, Au+Au@#sqrt{s_{NN}}=7.7 GeV"};
