...
TString inFileName= (TString) Form("../ROOTFile/UrQMD_Reco_7.7GeV_test_bin_pt.root");
TFile *outFile = new TFile(Form("./test.root"),"recreate");
TString outDirName=(TString)Form("%s_%s_Reco_test_pt_bin",model.Data(),energy.Data());
