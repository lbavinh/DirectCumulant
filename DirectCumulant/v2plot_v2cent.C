...
void plot(TString inFile)
{
  ...
  Double_t ymax = TMath::MaxElement(ncent,v2int)*1.1;
  ...
  char text[800];
  sprintf(text,"#splitline{MultMean=250}{#splitline{5#upoint10^{6} events}{-2#leq#eta#leq2}}");
