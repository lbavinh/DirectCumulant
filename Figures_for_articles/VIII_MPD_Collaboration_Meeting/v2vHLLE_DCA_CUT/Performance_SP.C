...
void Performance_SP()
{
  TString inputName[4] = {"./SecondRun_vHLLEUrQMD_11.5_Model_pt_weight.root",
                          "./SecondRun_vHLLEUrQMD_11.5_Reco_Nhits_32_DCA_2sigma_pt_weight.root",
                          "./SecondRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_3sigma_pt_weight.root",
                          "./SecondRun_vHLLEUrQMD_11.5_Reco_Nhits_16_DCA_4sigma_pt_weight.root"};
  ...
  TString title[]={"Model","Reco, 2#sigma_{DCA}","Reco, 3#sigma_{DCA}","Reco, 4#sigma_{DCA}"};
  ...
  for (int id = 0; id < npid; id++)
  {
    ...
    can->SaveAs(Form("Performance_v2_SP_%i%i_Model_vs_Nhits_16_DCA_3sigma_%s.pdf",centlow,centhigh,pidName[id].Data()));
  }
