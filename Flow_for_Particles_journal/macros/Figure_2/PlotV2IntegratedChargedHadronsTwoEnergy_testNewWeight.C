...
void PlotV2IntegratedChargedHadronsTwoEnergy_testNewWeight()
{
  ...
  const double minX = -1.;
  vector<TGraphErrors*> vGr77 = PlotV2IntegratedChargedHadrons("../FirstRun_7.7_new.root","../SecondRun_7.7_new.root");
  vector<TGraphErrors*> vGr115 = PlotV2IntegratedChargedHadrons("../FirstRun_11.5_new.root","../SecondRun_11.5_new.root");
  ...
  can->SaveAs("V2Cent_Others_AMPT_testNewWeight.png");
  can->SaveAs("V2Cent_Others_AMPT_testNewWeight.pdf");
