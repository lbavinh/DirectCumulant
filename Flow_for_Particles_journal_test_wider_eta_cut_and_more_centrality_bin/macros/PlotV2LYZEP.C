#define PLOTV2LYZEP
// bool bDebug = false;
TProfile *PlotV2LYZEPIntegrated(TProfile3D* &prV2,
...
TProfile *PlotV2LYZEPDifferentialVersusPt(TProfile3D *const &prV2,
...
TProfile *PlotV2LYZEPDifferentialVersusEta(TProfile3D*const &prV2,
                           const double pt_low = 0.2,
                           const double pt_high = 3.0,
                           const double cent_low = 10,
                           const double cent_high = 40)
...
void PlotV2LYZEP(TString inputFileName = "ThirdRun_AMPT15_7.7.root")
{
  TFile *fi = TFile::Open(inputFileName.Data());
  TProfile3D *pr = (TProfile3D *)fi->Get("prV2LYZEP");
  ...
  TProfile *prV2diffpt = PlotV2LYZEPDifferentialVersusPt(pr,10,40,1.5);
  ...
  TProfile *prV2diffpt4080 = PlotV2LYZEPDifferentialVersusPt(pr,40,80,1.5);
  ...
  TProfile *prV2int = PlotV2LYZEPIntegrated(pr,0.2,3.5,1.5);
