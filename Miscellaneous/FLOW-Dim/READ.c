...
//Референсный поток
SV2->Sumw2();SV4->Sumw2();
sv2=SV2->GetMean();v2=pow(fabs(sv2),0.5);RMSSV2=SV2->GetStdDev();
sv4=SV4->GetMean();cn4=sv4-2*(sv2*sv2);v4=pow(fabs(cn4),0.25);RMSSV4=SV4->GetStdDev();
vMC=HMC->GetMean();RMSVMC=HMC->GetStdDev();
