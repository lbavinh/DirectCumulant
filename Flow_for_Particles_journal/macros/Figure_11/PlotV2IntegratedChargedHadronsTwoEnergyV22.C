...
void PlotV2IntegratedChargedHadronsTwoEnergyV22()
{
  ...
  // leg1->Draw();
  vGr77.at(ratioToMethod)->SetTitle(";Centrality, %;#it{v}_{2}{2}");
  ...
  tex.DrawLatex(3,maxRatio*0.9,"(e)");
  can->cd(4);
  ...
  tex.DrawLatex(3,maxRatio*0.9,"(f)");
  can->SaveAs("V22Cent_AMPT_vs_UrQMD.png");
  can->SaveAs("V22Cent_AMPT_vs_UrQMD.pdf");
