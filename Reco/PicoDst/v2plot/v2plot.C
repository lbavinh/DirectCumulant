...
TString inFileName= (TString) Form("../ROOTFile/%s_MC_%s.root",model.Data(),energy.Data());
TFile *outFile = new TFile(Form("./v2_%s_%s_MC.root",model.Data(),energy.Data()),"recreate");
TString outDirName=(TString)Form("%s_%s_MC",model.Data(),energy.Data());
