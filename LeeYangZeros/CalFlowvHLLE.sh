...
model=vHLLEUrQMD
energy=39
macro=FlowLeeYangZeros
export MAIN_DIR=/weekly/${USER}/lbavinh/LYZ
export FILELIST=/weekly/${USER}/lbavinh/FlowFluctuations/runlistSGE_${model}_${energy}.list
