void v2plot()
{
  TFile *file = new TFile("v2QC_10000.root");
  ...
  for(int it=0; it<24; it++){
    ...
    (void) sprintf(hname1,"hv2ptMC_%i",it);
    ...
    (void) sprintf(hname2,"hv2ptTwo_%i",it);
    h4 = (TH1F*) file->Get(hname2);
    v22[it]=(h4->GetMean())/res2rxn;
    cout << v22 << " ";
    rms=(h4->GetRMS());
    nent=(h4->GetEntries());
    err =rms/sqrt(nent);
  ...
  auto gr2 = new TGraphErrors(24,hpt,v2,hpte,v2e);
  ...
  legC12->AddEntry(gr2,"V_{2}{2,QC}","lp");
