...
sprintf(path1,"./v2methods115ptCent20-30.txt");
sprintf(path2,"./v2methods115ptCent20-30.txt");
sprintf(path3,"./v2methods115ptCent20-30.txt");
...
line = new TLine(0.1,1.,3.2,1.);
 ...
 TLegend *legC2 = new TLegend(0.18,0.8,0.48,.88);
  ...
  legC2->AddEntry(gr1,"v_{2}{#eta-sub}/V_{2}{2}","p");
...
TLatex *   tex = new TLatex(1.5,1.3,"Au+Au at #sqrt{s_{NN}} = 11.5  GeV");
   tex->SetLineWidth(2);
...
gr3->Draw("PZ");
 ...
 TLatex *   tex2 = new TLatex(1.5,0.27,"Au+Au at #sqrt{s_{NN}} = 11.5  GeV");
   tex2->SetLineWidth(2);
