...
TFile *outFile = new TFile("../CompareResult/VinhPID_GEANT_merged.root","recreate");
TString outDirName={"Geant_merged"};
...
void v2plot_differential_flow(){
  ...
  */
  ...
  double eV22Dif1040CH[npt]={0.000184352,0.000242554,0.000331856,0.000447068,0.000586724,0.000691675,0.00107433,0.00150249,0.00561916};
  double eV22Dif1040Pion[npt]={0.000196671,0.000282831,0.00042767,0.000643264,0.000921627,0.00116782,0.00199257,0.0031438,0.0142042};
  double eV22Dif1040Kaon[npt]={0.000811804,0.00079672,0.000957661,0.00123581,0.00164957,0.00204605,0.00353233,0.00562709,0.023761};
  double eV22Dif1040Proton[npt]={0.000848259,0.000609956,0.000574455,0.000630378,0.000759466,0.000857897,0.00132627,0.00182918,0.00675633};
