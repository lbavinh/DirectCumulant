...
hadd -f -j 20 /weekly/$USER/lbavinh/FlowFluctuations/OUT/vHLLEUrQMD_7.7GeV.root  /weekly/$USER/lbavinh/FlowFluctuations/OUT/2187779/sum_*_*.root
hadd -f -j 20 /weekly/$USER/lbavinh/FlowFluctuations/OUT/vHLLEUrQMD_11.5GeV.root /weekly/$USER/lbavinh/FlowFluctuations/OUT/2187980/sum_*_*.root
hadd -f -j 20 /weekly/$USER/lbavinh/FlowFluctuations/OUT/vHLLEUrQMD_19.6GeV.root /weekly/$USER/lbavinh/FlowFluctuations/OUT/2187981/sum_*_*.root
hadd -f -j 20 /weekly/$USER/lbavinh/FlowFluctuations/OUT/vHLLEUrQMD_27GeV.root   /weekly/$USER/lbavinh/FlowFluctuations/OUT/2187982/sum_*_*.root
hadd -f -j 20 /weekly/$USER/lbavinh/FlowFluctuations/OUT/vHLLEUrQMD_39GeV.root   /weekly/$USER/lbavinh/FlowFluctuations/OUT/2187983/sum_*_*.root