...
void Test(TString inputFirstRunFileName = input1, TString inputSecondRunFileName = input2)
{
  ...
  for (int ic=firstCentToDraw; ic<firstCentToDraw+numberOfCentToDraw; ic++)
  {
    ...
    can->cd(padID);
    vGr_ratio[ic].at(ratioToMethod)->Draw("AP PLC PMC");
    if (ic==firstCentToDraw)
    {
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetTitleSize(titleSize);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetLabelSize(labelSize);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetTitleSize(titleSize);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetLabelSize(labelSize);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetTitleOffset(titleOffSet);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetTitleOffset(1.);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetLabelOffset(0.017);
    tex.SetTextSize(titleSize);
    }
    else
    {
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetTitleSize(titleSize+0.015);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetLabelSize(labelSize+0.015);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetTitleSize(titleSize+0.015);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetLabelSize(labelSize+0.015);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetTitleFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetLabelFont(textFont);
    vGr_ratio[ic].at(ratioToMethod)->GetYaxis()->SetTitleOffset(titleOffSet-0.1);
    vGr_ratio[ic].at(ratioToMethod)->GetXaxis()->SetTitleOffset(0.8);
    tex.SetTextSize(titleSize+0.015);
    }
    ...
    vGr_ratio[ic].at(ratioToMethod)->SetTitle(Form(";#it{p}_{T}, GeV/c;Ratio to %s", title[ratioToMethod].Data()));
    
    tex.DrawLatex(0.2,1.08,padName[padID-1].Data());
  }
  can->SaveAs(Form("CompareMethods_Diff_v2{2,eta-gap}_vs_others_at_%s.png",energy.Data()));
  can->SaveAs(Form("CompareMethods_Diff_v2{2,eta-gap}_vs_others_at_%s.pdf",energy.Data()));
