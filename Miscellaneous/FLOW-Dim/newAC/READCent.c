...
cout<<""<<endl;
    ...
    TCanvas *c2 = new TCanvas("c2", "Ref Flow Cent", 0, 0, 800, 600);
    ...
    TCanvas *c3 = new TCanvas("c3", "Ref Flow be Centrality", 10, 10, 800, 600);
    ...
    TCanvas *c1 = new TCanvas("c1", "Def Flow for cent", 0, 0, 800, 600);
    grv4[cent]->Draw("AP");
