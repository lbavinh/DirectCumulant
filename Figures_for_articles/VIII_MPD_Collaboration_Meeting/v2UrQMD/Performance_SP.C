...
#include "constants.C"
// vector<TGraphErrors*>*
void Performance_SP(TString inputMC = "SecondRun_UrQMD_7.7.root", TString inputRECO = "SecondRun_UrQMD_7.7_Reco.root")
{
  Int_t centlow = 10;
  Int_t centhigh = 40;
  ...
  can->SaveAs(Form("Performance_v2_SP_%i%i_Model_vs_Reco.pdf",centlow,centhigh));
  }
